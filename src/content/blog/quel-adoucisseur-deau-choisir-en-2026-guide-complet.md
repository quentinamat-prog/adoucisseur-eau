...
faq:
  - q: "Quelle capacité d'adoucisseur choisir pour 4 personnes ?"
    a: "Pour un foyer de 4 personnes avec une eau moyennement dure (25-30 °f), une résine de 25 à 30 litres est généralement suffisante. Si votre eau dépasse 40 °f, optez pour 35 litres."
  - q: "Vaut-il mieux un adoucisseur monobloc ou bi-bloc ?"
    a: "Le monobloc est plus compact et plus simple à installer. Le bi-bloc offre plus de flexibilité pour séparer le bac à sel de l'unité de traitement, utile quand l'espace est contraint."
  - q: "L'adoucisseur d'eau connecté vaut-il le surcoût ?"
...
<div style="background: linear-gradient(135deg, #0D5E77 0%, #1A96B4 100%); border-radius: 16px; padding: 24px 28px; margin: 32px 0; display: flex; align-items: flex-start; gap: 20px;">
  ...
  <div style="flex: 1;">
    <p style="color: #F5FBFD; font-weight: 700; font-size: 1.1rem; margin: 0 0 8px 0;">Vous ne savez pas par où commencer ?</p>
    <p style="color: rgba(245,251,253,0.85); margin: 0 0 16px 0; font-size: 0.95rem; line-height: 1.6;">Obtenez une recommandation personnalisée selon votre foyer et votre eau en moins de 2 minutes.</p>
